...
(async () => {
  try {
    ...
    const queries = [
      ...
      `,
      'REFRESH MATERIALIZED VIEW covid_data_state_metadata',
      ...
      `,
      'REFRESH MATERIALIZED VIEW covid_data_covid_tracking',
    ];
...
next:
* fix the check id, cannot get more data into states ... US?
